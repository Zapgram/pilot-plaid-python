...
class TransactionBase(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["date"], typing_extensions.Literal["transaction_id"], typing_extensions.Literal["unofficial_currency_code"], typing_extensions.Literal["amount"], typing_extensions.Literal["account_id"], typing_extensions.Literal["pending"], typing_extensions.Literal["iso_currency_code"], typing_extensions.Literal["category"], typing_extensions.Literal["category_id"], typing_extensions.Literal["check_number"], typing_extensions.Literal["location"], typing_extensions.Literal["name"], typing_extensions.Literal["merchant_name"], typing_extensions.Literal["original_description"], typing_extensions.Literal["payment_meta"], typing_extensions.Literal["pending_transaction_id"], typing_extensions.Literal["account_owner"], typing_extensions.Literal["transaction_type"], typing_extensions.Literal["logo_url"], typing_extensions.Literal["website"], str, ]):
