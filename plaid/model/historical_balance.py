...
class HistoricalBalance(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["date"], typing_extensions.Literal["unofficial_currency_code"], typing_extensions.Literal["current"], typing_extensions.Literal["iso_currency_code"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["date"], typing_extensions.Literal["unofficial_currency_code"], typing_extensions.Literal["current"], typing_extensions.Literal["iso_currency_code"], str, ]):
