...
class TransferCancelRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["transfer_id", "client_id", "secret", "originator_client_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["transfer_id", "client_id", "secret", "originator_client_id", ], str]):
