...
class WatchlistScreeningHit(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def list_code() -> typing.Type['IndividualWatchlistCode']:
            ...
            @staticmethod
            def analysis() -> typing.Type['ScreeningHitAnalysis']:
                return ScreeningHitAnalysis
        
            @staticmethod
            def data() -> typing.Type['ScreeningHitData']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["list_code"]) -> 'IndividualWatchlistCode': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["historical_since"]) -> 'TimestampNullable': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["analysis"]) -> 'ScreeningHitAnalysis': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'ScreeningHitData': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["list_code"]) -> 'IndividualWatchlistCode': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["historical_since"]) -> 'TimestampNullable': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["analysis"]) -> typing.Union['ScreeningHitAnalysis', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> typing.Union['ScreeningHitData', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        list_code: 'IndividualWatchlistCode',
        historical_since: 'TimestampNullable',
        analysis: typing.Union['ScreeningHitAnalysis', schemas.Unset] = schemas.unset,
        data: typing.Union['ScreeningHitData', schemas.Unset] = schemas.unset,
