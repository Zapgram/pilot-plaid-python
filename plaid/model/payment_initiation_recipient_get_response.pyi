...
class PaymentInitiationRecipientGetResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name"], typing_extensions.Literal["request_id"], typing_extensions.Literal["recipient_id"], str, ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name"], typing_extensions.Literal["request_id"], typing_extensions.Literal["recipient_id"], str, ]):
        return super().get_item_oapg(name)
