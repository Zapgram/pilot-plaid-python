...
class DepositSwitchTokenCreateRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["deposit_switch_id", "client_id", "secret", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["deposit_switch_id", "client_id", "secret", ], str]):
