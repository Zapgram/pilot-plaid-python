...
class TransferListRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["client_id", "secret", "start_date", "end_date", "count", "offset", "origination_account_id", "originator_client_id", "funding_account_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["client_id", "secret", "start_date", "end_date", "count", "offset", "origination_account_id", "originator_client_id", "funding_account_id", ], str]):
