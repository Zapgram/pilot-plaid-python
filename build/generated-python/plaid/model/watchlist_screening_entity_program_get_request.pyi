...
class WatchlistScreeningEntityProgramGetRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entity_watchlist_program_id", "secret", "client_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["entity_watchlist_program_id", "secret", "client_id", ], str]):
