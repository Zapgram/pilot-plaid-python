...
class ProcessorTokenPermissionsGetResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["request_id"], typing_extensions.Literal["products"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["request_id"], typing_extensions.Literal["products"], str, ]):
