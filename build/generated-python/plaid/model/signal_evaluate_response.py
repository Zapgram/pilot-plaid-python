...
class SignalEvaluateResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["scores"], typing_extensions.Literal["warnings"], typing_extensions.Literal["request_id"], typing_extensions.Literal["core_attributes"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["scores"], typing_extensions.Literal["warnings"], typing_extensions.Literal["request_id"], typing_extensions.Literal["core_attributes"], str, ]):
