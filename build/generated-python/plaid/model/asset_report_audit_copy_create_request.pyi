...
class AssetReportAuditCopyCreateRequest(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["auditor_id"]) -> MetaOapg.properties.auditor_id: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["asset_report_token", "client_id", "secret", "auditor_id", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["auditor_id"]) -> typing.Union[MetaOapg.properties.auditor_id, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["asset_report_token", "client_id", "secret", "auditor_id", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        auditor_id: typing.Union[MetaOapg.properties.auditor_id, str, schemas.Unset] = schemas.unset,
