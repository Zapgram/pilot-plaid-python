...
class WatchlistScreeningEntityCreateRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def search_terms() -> typing.Type['EntityWatchlistSearchTerms']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["search_terms"]) -> 'EntityWatchlistSearchTerms': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["search_terms"]) -> 'EntityWatchlistSearchTerms': ...
