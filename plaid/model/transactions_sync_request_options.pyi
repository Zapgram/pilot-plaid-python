...
class TransactionsSyncRequestOptions(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["include_original_description", "include_personal_finance_category", "include_logo_and_counterparty_beta", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["include_original_description", "include_personal_finance_category", "include_logo_and_counterparty_beta", ], str]):
