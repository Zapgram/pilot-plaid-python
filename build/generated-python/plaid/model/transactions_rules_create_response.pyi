...
class TransactionsRulesCreateResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def rule() -> typing.Type['TransactionsCategoryRule']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["rule"]) -> 'TransactionsCategoryRule': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["rule"], typing_extensions.Literal["request_id"], str, ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["rule"]) -> 'TransactionsCategoryRule': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["rule"], typing_extensions.Literal["request_id"], str, ]):
