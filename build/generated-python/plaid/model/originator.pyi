...
class Originator(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["transfer_diligence_status"], typing_extensions.Literal["client_id"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["transfer_diligence_status"], typing_extensions.Literal["client_id"], str, ]):
