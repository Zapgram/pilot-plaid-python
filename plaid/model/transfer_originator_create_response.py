...
class TransferOriginatorCreateResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["originator_client_id"], typing_extensions.Literal["company_name"], typing_extensions.Literal["request_id"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["originator_client_id"], typing_extensions.Literal["company_name"], typing_extensions.Literal["request_id"], str, ]):
