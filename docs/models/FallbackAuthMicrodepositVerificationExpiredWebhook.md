# plaid.model.fallback_auth_microdeposit_verification_expired_webhook.FallbackAuthMicrodepositVerificationExpiredWebhook
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Fires when an account has an expired verification when using micro-deposits | 
