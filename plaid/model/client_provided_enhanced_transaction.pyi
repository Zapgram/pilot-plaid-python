...
class ClientProvidedEnhancedTransaction(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def enhancements() -> typing.Type['Enhancements']:
                return Enhancements
            __annotations__ = {
                "id": id,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["enhancements"]) -> 'Enhancements': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["amount"], typing_extensions.Literal["enhancements"], typing_extensions.Literal["iso_currency_code"], typing_extensions.Literal["description"], typing_extensions.Literal["id"], str, ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["enhancements"]) -> 'Enhancements': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["amount"], typing_extensions.Literal["enhancements"], typing_extensions.Literal["iso_currency_code"], typing_extensions.Literal["description"], typing_extensions.Literal["id"], str, ]):
