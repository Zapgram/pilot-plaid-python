...
class SandboxProcessorTokenCreateRequestOptions(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["override_username", "override_password", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["override_username", "override_password", ], str]):
