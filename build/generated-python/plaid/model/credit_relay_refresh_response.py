...
class CreditRelayRefreshResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["relay_token"], typing_extensions.Literal["request_id"], typing_extensions.Literal["asset_report_id"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["relay_token"], typing_extensions.Literal["request_id"], typing_extensions.Literal["asset_report_id"], str, ]):
