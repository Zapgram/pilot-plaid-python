...
class AssetReportGetResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def report() -> typing.Type['AssetReport']:
                return AssetReport
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["report"]) -> 'AssetReport': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["warnings"], typing_extensions.Literal["report"], typing_extensions.Literal["request_id"], str, ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["report"]) -> 'AssetReport': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["warnings"], typing_extensions.Literal["report"], typing_extensions.Literal["request_id"], str, ]):
