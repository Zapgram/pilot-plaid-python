...
class EntityScreeningHitsPhoneNumberItems(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['EntityScreeningHitPhoneNumbers']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'EntityScreeningHitPhoneNumbers': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> typing.Union['EntityScreeningHitPhoneNumbers', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        data: typing.Union['EntityScreeningHitPhoneNumbers', schemas.Unset] = schemas.unset,
