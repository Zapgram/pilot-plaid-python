...
class NumbersInternational(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["account_id"], typing_extensions.Literal["iban"], typing_extensions.Literal["bic"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["account_id"], typing_extensions.Literal["iban"], typing_extensions.Literal["bic"], str, ]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        bic: typing.Union[MetaOapg.properties.bic, str, ],
