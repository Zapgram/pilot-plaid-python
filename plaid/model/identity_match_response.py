        ...
        class properties:
            ...
            class accounts(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['AccountIdentityMatchScore']:
                        return AccountIdentityMatchScore
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['AccountIdentityMatchScore'], typing.List['AccountIdentityMatchScore']],
                ...
                def __getitem__(self, i: int) -> 'AccountIdentityMatchScore':
