...
class EmployersSearchRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["query", "products", "client_id", "secret", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["query", "products", "client_id", "secret", ], str]):
