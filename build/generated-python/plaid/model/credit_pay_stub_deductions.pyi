...
class CreditPayStubDeductions(
        ...
        class properties:
            ...
            class breakdown(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['PayStubDeductionsBreakdown']:
                        return PayStubDeductionsBreakdown
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['PayStubDeductionsBreakdown'], typing.List['PayStubDeductionsBreakdown']],
                ...
                def __getitem__(self, i: int) -> 'PayStubDeductionsBreakdown':
                    return super().__getitem__(i)
        
            @staticmethod
            def total() -> typing.Type['PayStubDeductionsTotal']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["total"]) -> 'PayStubDeductionsTotal': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["total"]) -> 'PayStubDeductionsTotal': ...
