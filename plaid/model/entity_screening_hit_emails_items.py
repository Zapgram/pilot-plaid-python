...
class EntityScreeningHitEmailsItems(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['EntityScreeningHitEmails']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'EntityScreeningHitEmails': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> typing.Union['EntityScreeningHitEmails', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        data: typing.Union['EntityScreeningHitEmails', schemas.Unset] = schemas.unset,
