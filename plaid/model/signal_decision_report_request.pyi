...
class SignalDecisionReportRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["client_transaction_id", "initiated", "client_id", "secret", "days_funds_on_hold", "decision_outcome", "payment_method", "amount_instantly_available", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["client_transaction_id", "initiated", "client_id", "secret", "days_funds_on_hold", "decision_outcome", "payment_method", "amount_instantly_available", ], str]):
