...
class IdentityMatchRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def user() -> typing.Type['IdentityMatchUser']:
                return IdentityMatchUser
        
            @staticmethod
            def options() -> typing.Type['IdentityMatchRequestOptions']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["user"]) -> 'IdentityMatchUser': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["options"]) -> 'IdentityMatchRequestOptions': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["access_token", "client_id", "secret", "user", "options", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["user"]) -> typing.Union['IdentityMatchUser', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["options"]) -> typing.Union['IdentityMatchRequestOptions', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["access_token", "client_id", "secret", "user", "options", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        user: typing.Union['IdentityMatchUser', schemas.Unset] = schemas.unset,
        options: typing.Union['IdentityMatchRequestOptions', schemas.Unset] = schemas.unset,
