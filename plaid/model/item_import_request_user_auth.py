...
class ItemImportRequestUserAuth(
    ...
    auth_token: MetaOapg.properties.auth_token
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["user_id", "auth_token", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["auth_token"]) -> MetaOapg.properties.auth_token: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["user_id", "auth_token", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        auth_token: typing.Union[MetaOapg.properties.auth_token, str, ],
