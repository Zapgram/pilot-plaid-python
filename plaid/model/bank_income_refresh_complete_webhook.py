...
class BankIncomeRefreshCompleteWebhook(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def result() -> typing.Type['BankIncomeRefreshCompleteResult']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["result"]) -> 'BankIncomeRefreshCompleteResult': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["result"], typing_extensions.Literal["environment"], typing_extensions.Literal["webhook_type"], typing_extensions.Literal["user_id"], typing_extensions.Literal["webhook_code"], str, ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["result"]) -> 'BankIncomeRefreshCompleteResult': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["result"], typing_extensions.Literal["environment"], typing_extensions.Literal["webhook_type"], typing_extensions.Literal["user_id"], typing_extensions.Literal["webhook_code"], str, ]):
