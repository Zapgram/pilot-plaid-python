...
class ScreeningHitDateOfBirthItem(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['DateRange']:
                return DateRange
            __annotations__ = {
                "analysis": analysis,
                "data": data,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'DateRange': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> typing.Union['DateRange', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        data: typing.Union['DateRange', schemas.Unset] = schemas.unset,
