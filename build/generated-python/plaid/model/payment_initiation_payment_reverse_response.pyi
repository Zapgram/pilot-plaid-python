...
class PaymentInitiationPaymentReverseResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["refund_id"], typing_extensions.Literal["request_id"], typing_extensions.Literal["status"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["refund_id"], typing_extensions.Literal["request_id"], typing_extensions.Literal["status"], str, ]):
        return super().get_item_oapg(name)

    def __new__(
        cls,
        *_args: typing.Union[dict, frozendict.frozendict, ],
        refund_id: typing.Union[MetaOapg.properties.refund_id, str, ],
