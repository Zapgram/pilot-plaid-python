...
class PaymentProfileCreateResponse(
    ...
    payment_profile_token: MetaOapg.properties.payment_profile_token
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["payment_profile_token"], typing_extensions.Literal["request_id"], str, ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["payment_profile_token"]) -> MetaOapg.properties.payment_profile_token: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["payment_profile_token"], typing_extensions.Literal["request_id"], str, ]):
        return super().get_item_oapg(name)

    def __new__(
        cls,
        *_args: typing.Union[dict, frozendict.frozendict, ],
        payment_profile_token: typing.Union[MetaOapg.properties.payment_profile_token, str, ],
