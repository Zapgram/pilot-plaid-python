...
class IncomeVerificationCreateRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def options() -> typing.Type['IncomeVerificationCreateRequestOptions']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["options"]) -> 'IncomeVerificationCreateRequestOptions': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["webhook", "client_id", "secret", "precheck_id", "options", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["options"]) -> typing.Union['IncomeVerificationCreateRequestOptions', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["webhook", "client_id", "secret", "precheck_id", "options", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        options: typing.Union['IncomeVerificationCreateRequestOptions', schemas.Unset] = schemas.unset,
