...
class TransactionCounterparty(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["website"], typing_extensions.Literal["logo_url"], typing_extensions.Literal["name"], typing_extensions.Literal["type"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["website"], typing_extensions.Literal["logo_url"], typing_extensions.Literal["name"], typing_extensions.Literal["type"], str, ]):
