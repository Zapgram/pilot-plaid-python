...
class WatchlistScreeningIndividual(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["search_terms"], typing_extensions.Literal["audit_trail"], typing_extensions.Literal["client_user_id"], typing_extensions.Literal["assignee"], typing_extensions.Literal["id"], typing_extensions.Literal["status"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["search_terms"], typing_extensions.Literal["audit_trail"], typing_extensions.Literal["client_user_id"], typing_extensions.Literal["assignee"], typing_extensions.Literal["id"], typing_extensions.Literal["status"], str, ]):
