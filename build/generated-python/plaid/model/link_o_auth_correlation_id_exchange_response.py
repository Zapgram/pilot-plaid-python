...
class LinkOAuthCorrelationIdExchangeResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["link_token"], typing_extensions.Literal["request_id"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["link_token"], typing_extensions.Literal["request_id"], str, ]):
