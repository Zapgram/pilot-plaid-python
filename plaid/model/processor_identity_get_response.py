...
class ProcessorIdentityGetResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def account() -> typing.Type['AccountIdentity']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["account"]) -> 'AccountIdentity': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["account"]) -> 'AccountIdentity': ...
