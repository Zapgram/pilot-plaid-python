...
class InvestmentsHoldingsGetRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def options() -> typing.Type['InvestmentHoldingsGetRequestOptions']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["options"]) -> 'InvestmentHoldingsGetRequestOptions': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["options"]) -> typing.Union['InvestmentHoldingsGetRequestOptions', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        options: typing.Union['InvestmentHoldingsGetRequestOptions', schemas.Unset] = schemas.unset,
