...
class CreditFreddieMacVerificationOfAssetResponseVOE25(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def ASSETS() -> typing.Type['CreditFreddieMacAssetsVOE25']:
                return CreditFreddieMacAssetsVOE25
            __annotations__ = {
                "ASSETS": ASSETS,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ASSETS"]) -> 'CreditFreddieMacAssetsVOE25': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ASSETS"]) -> 'CreditFreddieMacAssetsVOE25': ...
