...
class PaymentInitiationConsentPaymentExecuteRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def idempotency_key() -> typing.Type['ConsentPaymentIdempotencyKey']:
                return ConsentPaymentIdempotencyKey
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["idempotency_key"]) -> 'ConsentPaymentIdempotencyKey': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["consent_id", "amount", "idempotency_key", "client_id", "secret", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["idempotency_key"]) -> 'ConsentPaymentIdempotencyKey': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["consent_id", "amount", "idempotency_key", "client_id", "secret", ], str]):
