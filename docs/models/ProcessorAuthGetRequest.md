# plaid.model.processor_auth_get_request.ProcessorAuthGetRequest
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | ProcessorAuthGetRequest defines the request schema for &#x60;/processor/auth/get&#x60; | 
