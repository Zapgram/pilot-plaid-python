...
class LiabilitiesGetResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def liabilities() -> typing.Type['LiabilitiesObject']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["liabilities"]) -> 'LiabilitiesObject': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["item"], typing_extensions.Literal["liabilities"], typing_extensions.Literal["accounts"], typing_extensions.Literal["request_id"], str, ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["liabilities"]) -> 'LiabilitiesObject': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["item"], typing_extensions.Literal["liabilities"], typing_extensions.Literal["accounts"], typing_extensions.Literal["request_id"], str, ]):
