...
class ExternalPaymentOptions(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["request_refund_details", "iban", "bacs", "scheme", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["request_refund_details", "iban", "bacs", "scheme", ], str]):
