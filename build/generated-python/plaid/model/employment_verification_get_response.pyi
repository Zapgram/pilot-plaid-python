...
class EmploymentVerificationGetResponse(
        ...
        class properties:
            ...
            class employments(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['EmploymentVerification']:
                        return EmploymentVerification
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['EmploymentVerification'], typing.List['EmploymentVerification']],
                ...
                def __getitem__(self, i: int) -> 'EmploymentVerification':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["employments"], typing_extensions.Literal["request_id"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["employments"], typing_extensions.Literal["request_id"], str, ]):
