...
class IncomeVerificationCreateRequestOptions(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["access_tokens", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["access_tokens", ], str]):
