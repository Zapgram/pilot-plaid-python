...
class UserCreateRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["client_user_id", "client_id", "secret", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["client_user_id", "client_id", "secret", ], str]):
