...
class PendingExpirationWebhook(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            consent_expiration_time = schemas.DateTimeSchema
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["environment"], typing_extensions.Literal["webhook_type"], typing_extensions.Literal["item_id"], typing_extensions.Literal["consent_expiration_time"], typing_extensions.Literal["webhook_code"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["environment"], typing_extensions.Literal["webhook_type"], typing_extensions.Literal["item_id"], typing_extensions.Literal["consent_expiration_time"], typing_extensions.Literal["webhook_code"], str, ]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        consent_expiration_time: typing.Union[MetaOapg.properties.consent_expiration_time, str, datetime, ],
