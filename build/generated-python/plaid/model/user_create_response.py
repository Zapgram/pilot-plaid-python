...
class UserCreateResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["user_id"], typing_extensions.Literal["user_token"], typing_extensions.Literal["request_id"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["user_id"], typing_extensions.Literal["user_token"], typing_extensions.Literal["request_id"], str, ]):
