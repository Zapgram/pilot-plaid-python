...
class WatchlistScreeningIndividualCreateRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def search_terms() -> typing.Type['WatchlistScreeningRequestSearchTerms']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["search_terms"]) -> 'WatchlistScreeningRequestSearchTerms': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["search_terms", "client_user_id", "client_id", "secret", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["search_terms"]) -> 'WatchlistScreeningRequestSearchTerms': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["search_terms", "client_user_id", "client_id", "secret", ], str]):
