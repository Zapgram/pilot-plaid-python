...
class IncomeVerificationDocumentsDownloadRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["client_id", "secret", "income_verification_id", "access_token", "document_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["client_id", "secret", "income_verification_id", "access_token", "document_id", ], str]):
