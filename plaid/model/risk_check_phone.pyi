...
class RiskCheckPhone(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["linked_services"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["linked_services"], str, ]):
