...
class AssetDetail(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            AssetAvailableBalanceAmount = schemas.Float64Schema
            AssetCurrentBalanceAmount = schemas.Float64Schema
            ...
            __annotations__ = {
                ...
                "AssetAvailableBalanceAmount": AssetAvailableBalanceAmount,
                "AssetCurrentBalanceAmount": AssetCurrentBalanceAmount,
                "AssetType": AssetType,
    ...
    AssetAvailableBalanceAmount: MetaOapg.properties.AssetAvailableBalanceAmount
    AssetCurrentBalanceAmount: MetaOapg.properties.AssetCurrentBalanceAmount
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["AssetAvailableBalanceAmount"]) -> MetaOapg.properties.AssetAvailableBalanceAmount: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["AssetCurrentBalanceAmount"]) -> MetaOapg.properties.AssetCurrentBalanceAmount: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["AssetDaysRequestedCount"], typing_extensions.Literal["AssetOwnershipType"], typing_extensions.Literal["AssetType"], typing_extensions.Literal["AssetAccountIdentifier"], typing_extensions.Literal["AssetDescription"], typing_extensions.Literal["AssetAsOfDate"], typing_extensions.Literal["AssetUniqueIdentifier"], typing_extensions.Literal["AssetAvailableBalanceAmount"], typing_extensions.Literal["AssetCurrentBalanceAmount"], typing_extensions.Literal["AssetTypeAdditionalDescription"], str, ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AssetAvailableBalanceAmount"]) -> MetaOapg.properties.AssetAvailableBalanceAmount: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AssetCurrentBalanceAmount"]) -> MetaOapg.properties.AssetCurrentBalanceAmount: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        AssetAvailableBalanceAmount: typing.Union[MetaOapg.properties.AssetAvailableBalanceAmount, decimal.Decimal, int, float, ],
        AssetCurrentBalanceAmount: typing.Union[MetaOapg.properties.AssetCurrentBalanceAmount, decimal.Decimal, int, float, ],
