# plaid.model.processor_identity_get_request.ProcessorIdentityGetRequest
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | ProcessorIdentityGetRequest defines the request schema for &#x60;/processor/identity/get&#x60; | 
