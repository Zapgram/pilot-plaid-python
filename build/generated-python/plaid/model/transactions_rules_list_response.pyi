...
class TransactionsRulesListResponse(
        ...
        class properties:
            ...
            class rules(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TransactionsCategoryRule']:
                        return TransactionsCategoryRule
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['TransactionsCategoryRule'], typing.List['TransactionsCategoryRule']],
                ...
                def __getitem__(self, i: int) -> 'TransactionsCategoryRule':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["rules"], typing_extensions.Literal["request_id"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["rules"], typing_extensions.Literal["request_id"], str, ]):
