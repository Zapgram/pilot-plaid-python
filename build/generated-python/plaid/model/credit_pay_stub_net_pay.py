...
class CreditPayStubNetPay(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["current_amount"], typing_extensions.Literal["unofficial_currency_code"], typing_extensions.Literal["ytd_amount"], typing_extensions.Literal["iso_currency_code"], typing_extensions.Literal["description"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["current_amount"], typing_extensions.Literal["unofficial_currency_code"], typing_extensions.Literal["ytd_amount"], typing_extensions.Literal["iso_currency_code"], typing_extensions.Literal["description"], str, ]):
