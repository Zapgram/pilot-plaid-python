...
class AuthGetResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def numbers() -> typing.Type['AuthGetNumbers']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["numbers"]) -> 'AuthGetNumbers': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["item"], typing_extensions.Literal["numbers"], typing_extensions.Literal["accounts"], typing_extensions.Literal["request_id"], str, ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["numbers"]) -> 'AuthGetNumbers': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["item"], typing_extensions.Literal["numbers"], typing_extensions.Literal["accounts"], typing_extensions.Literal["request_id"], str, ]):
