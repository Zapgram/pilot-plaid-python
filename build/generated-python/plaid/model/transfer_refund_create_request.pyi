...
class TransferRefundCreateRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def idempotency_key() -> typing.Type['TransferRefundIdempotencyKey']:
                return TransferRefundIdempotencyKey
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["idempotency_key"]) -> 'TransferRefundIdempotencyKey': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["transfer_id", "amount", "idempotency_key", "client_id", "secret", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["idempotency_key"]) -> 'TransferRefundIdempotencyKey': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["transfer_id", "amount", "idempotency_key", "client_id", "secret", ], str]):
