...
class CreditAuditCopyTokenCreateRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["report_tokens", "client_id", "secret", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["report_tokens", "client_id", "secret", ], str]):
