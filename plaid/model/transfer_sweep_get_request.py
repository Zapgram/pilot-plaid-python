...
class TransferSweepGetRequest(
    ...
    sweep_id: MetaOapg.properties.sweep_id
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["sweep_id", "client_id", "secret", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["sweep_id"]) -> MetaOapg.properties.sweep_id: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["sweep_id", "client_id", "secret", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        sweep_id: typing.Union[MetaOapg.properties.sweep_id, str, ],
