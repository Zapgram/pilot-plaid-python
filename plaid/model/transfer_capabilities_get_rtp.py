...
class TransferCapabilitiesGetRTP(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["credit"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["credit"], str, ]):
        return super().get_item_oapg(name)

    def __new__(
        cls,
        *_args: typing.Union[dict, frozendict.frozendict, ],
        credit: typing.Union[MetaOapg.properties.credit, bool, schemas.Unset] = schemas.unset,
