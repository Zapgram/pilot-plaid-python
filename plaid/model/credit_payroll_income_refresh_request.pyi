...
class CreditPayrollIncomeRefreshRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def options() -> typing.Type['CreditPayrollIncomeRefreshRequestOptions']:
                return CreditPayrollIncomeRefreshRequestOptions
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["options"]) -> 'CreditPayrollIncomeRefreshRequestOptions': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["options"]) -> typing.Union['CreditPayrollIncomeRefreshRequestOptions', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        options: typing.Union['CreditPayrollIncomeRefreshRequestOptions', schemas.Unset] = schemas.unset,
