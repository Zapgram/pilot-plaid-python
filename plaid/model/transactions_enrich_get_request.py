...
class TransactionsEnrichGetRequest(
        ...
        class properties:
            ...
            class transactions(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ClientProvidedTransaction']:
                        return ClientProvidedTransaction
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ClientProvidedTransaction'], typing.List['ClientProvidedTransaction']],
                ...
                def __getitem__(self, i: int) -> 'ClientProvidedTransaction':
                    return super().__getitem__(i)
            client_id = schemas.StrSchema
            secret = schemas.StrSchema
        
            @staticmethod
            def options() -> typing.Type['TransactionsEnrichRequestOptions']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["options"]) -> 'TransactionsEnrichRequestOptions': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["account_type", "transactions", "client_id", "secret", "options", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["options"]) -> typing.Union['TransactionsEnrichRequestOptions', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["account_type", "transactions", "client_id", "secret", "options", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        options: typing.Union['TransactionsEnrichRequestOptions', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
