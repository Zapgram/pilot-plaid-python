# plaid.model.partner_customer_remove_response.PartnerCustomerRemoveResponse
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Response schema for &#x60;/partner/customer/remove&#x60;. | 
