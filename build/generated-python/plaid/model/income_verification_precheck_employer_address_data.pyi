...
class IncomeVerificationPrecheckEmployerAddressData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["city"], typing_extensions.Literal["country"], typing_extensions.Literal["postal_code"], typing_extensions.Literal["region"], typing_extensions.Literal["street"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["city"], typing_extensions.Literal["country"], typing_extensions.Literal["postal_code"], typing_extensions.Literal["region"], typing_extensions.Literal["street"], str, ]):
