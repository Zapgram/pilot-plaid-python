...
class SignalEvaluateRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["access_token", "account_id", "client_transaction_id", "amount", "client_id", "secret", "user_present", "client_user_id", "is_recurring", "default_payment_method", "user", "device", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["access_token", "account_id", "client_transaction_id", "amount", "client_id", "secret", "user_present", "client_user_id", "is_recurring", "default_payment_method", "user", "device", ], str]):
