...
class WebhookUpdateAcknowledgedWebhook(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["environment"], typing_extensions.Literal["webhook_type"], typing_extensions.Literal["item_id"], typing_extensions.Literal["new_webhook_url"], typing_extensions.Literal["webhook_code"], typing_extensions.Literal["error"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["environment"], typing_extensions.Literal["webhook_type"], typing_extensions.Literal["item_id"], typing_extensions.Literal["new_webhook_url"], typing_extensions.Literal["webhook_code"], typing_extensions.Literal["error"], str, ]):
