...
class StandaloneCurrencyCodeList(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            unofficial_currency_code = schemas.StrSchema
            __annotations__ = {
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["unofficial_currency_code"], typing_extensions.Literal["iso_currency_code"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["unofficial_currency_code"], typing_extensions.Literal["iso_currency_code"], str, ]):
        return super().get_item_oapg(name)

    def __new__(
        cls,
        *_args: typing.Union[dict, frozendict.frozendict, ],
        unofficial_currency_code: typing.Union[MetaOapg.properties.unofficial_currency_code, str, ],
