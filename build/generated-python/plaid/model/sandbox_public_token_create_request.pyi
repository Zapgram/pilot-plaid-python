...
class SandboxPublicTokenCreateRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def options() -> typing.Type['SandboxPublicTokenCreateRequestOptions']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["options"]) -> 'SandboxPublicTokenCreateRequestOptions': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["institution_id", "initial_products", "client_id", "secret", "options", "user_token", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["options"]) -> typing.Union['SandboxPublicTokenCreateRequestOptions', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["institution_id", "initial_products", "client_id", "secret", "options", "user_token", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        options: typing.Union['SandboxPublicTokenCreateRequestOptions', schemas.Unset] = schemas.unset,
