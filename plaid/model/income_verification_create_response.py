...
class IncomeVerificationCreateResponse(
    ...
    income_verification_id: MetaOapg.properties.income_verification_id
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["income_verification_id"], typing_extensions.Literal["request_id"], str, ]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["income_verification_id"]) -> MetaOapg.properties.income_verification_id: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["income_verification_id"], typing_extensions.Literal["request_id"], str, ]):
        return super().get_item_oapg(name)

    def __new__(
        cls,
        *_args: typing.Union[dict, frozendict.frozendict, ],
        income_verification_id: typing.Union[MetaOapg.properties.income_verification_id, str, ],
