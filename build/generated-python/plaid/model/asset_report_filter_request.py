...
class AssetReportFilterRequest(
    ...
    account_ids_to_exclude: MetaOapg.properties.account_ids_to_exclude
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["account_ids_to_exclude"]) -> MetaOapg.properties.account_ids_to_exclude: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["asset_report_token", "account_ids_to_exclude", "client_id", "secret", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["account_ids_to_exclude"]) -> MetaOapg.properties.account_ids_to_exclude: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["asset_report_token", "account_ids_to_exclude", "client_id", "secret", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        account_ids_to_exclude: typing.Union[MetaOapg.properties.account_ids_to_exclude, list, tuple, ],
