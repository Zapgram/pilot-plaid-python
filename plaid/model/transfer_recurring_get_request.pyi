...
class TransferRecurringGetRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["recurring_transfer_id", "client_id", "secret", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["recurring_transfer_id", "client_id", "secret", ], str]):
