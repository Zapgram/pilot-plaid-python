...
class BankTransferSweepGetResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def sweep() -> typing.Type['BankTransferSweep']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["sweep"]) -> 'BankTransferSweep': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["sweep"]) -> 'BankTransferSweep': ...
