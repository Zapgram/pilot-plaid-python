...
class TransferEventSyncRequest(
    ...
    after_id: MetaOapg.properties.after_id
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["after_id"]) -> MetaOapg.properties.after_id: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["after_id", "client_id", "secret", "count", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["after_id"]) -> MetaOapg.properties.after_id: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["after_id", "client_id", "secret", "count", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        after_id: typing.Union[MetaOapg.properties.after_id, decimal.Decimal, int, ],
