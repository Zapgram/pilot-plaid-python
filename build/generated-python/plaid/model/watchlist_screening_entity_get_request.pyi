...
class WatchlistScreeningEntityGetRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entity_watchlist_screening_id", "secret", "client_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["entity_watchlist_screening_id", "secret", "client_id", ], str]):
