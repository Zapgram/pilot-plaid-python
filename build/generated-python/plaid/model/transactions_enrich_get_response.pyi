...
class TransactionsEnrichGetResponse(
        ...
        class properties:
            ...
            class enriched_transactions(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ClientProvidedEnrichedTransaction']:
                        return ClientProvidedEnrichedTransaction
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ClientProvidedEnrichedTransaction'], typing.List['ClientProvidedEnrichedTransaction']],
                ...
                def __getitem__(self, i: int) -> 'ClientProvidedEnrichedTransaction':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["enriched_transactions"], typing_extensions.Literal["request_id"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["enriched_transactions"], typing_extensions.Literal["request_id"], str, ]):
