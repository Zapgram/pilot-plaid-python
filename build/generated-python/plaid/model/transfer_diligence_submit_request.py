...
class TransferDiligenceSubmitRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def originator_diligence() -> typing.Type['TransferOriginatorDiligence']:
                return TransferOriginatorDiligence
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["originator_diligence"]) -> 'TransferOriginatorDiligence': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["originator_client_id", "originator_diligence", "client_id", "secret", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["originator_diligence"]) -> 'TransferOriginatorDiligence': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["originator_client_id", "originator_diligence", "client_id", "secret", ], str]):
