...
class WatchlistScreeningIndividualHitListRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["watchlist_screening_id", "secret", "client_id", "cursor", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["watchlist_screening_id", "secret", "client_id", "cursor", ], str]):
