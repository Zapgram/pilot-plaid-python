...
class EntityWatchlistProgram(
        ...
        class properties:
            ...
            class lists_enabled(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['EntityWatchlistCode']:
                        return EntityWatchlistCode
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['EntityWatchlistCode'], typing.List['EntityWatchlistCode']],
                ...
                def __getitem__(self, i: int) -> 'EntityWatchlistCode':
                    return super().__getitem__(i)
        
            @staticmethod
            def name() -> typing.Type['EntityWatchlistScreeningProgramName']:
                return EntityWatchlistScreeningProgramName
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["name"]) -> 'EntityWatchlistScreeningProgramName': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["lists_enabled"], typing_extensions.Literal["audit_trail"], typing_extensions.Literal["is_archived"], typing_extensions.Literal["name"], typing_extensions.Literal["created_at"], typing_extensions.Literal["name_sensitivity"], typing_extensions.Literal["id"], typing_extensions.Literal["is_rescanning_enabled"], str, ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["name"]) -> 'EntityWatchlistScreeningProgramName': ...
