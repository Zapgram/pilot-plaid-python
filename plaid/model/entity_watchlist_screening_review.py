...
against hits attached to the watchlist screening, or both.
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["dismissed_hits"], typing_extensions.Literal["audit_trail"], typing_extensions.Literal["confirmed_hits"], typing_extensions.Literal["comment"], typing_extensions.Literal["id"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["dismissed_hits"], typing_extensions.Literal["audit_trail"], typing_extensions.Literal["confirmed_hits"], typing_extensions.Literal["comment"], typing_extensions.Literal["id"], str, ]):
