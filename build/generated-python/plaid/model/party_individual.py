...
class PartyIndividual(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def NAME() -> typing.Type['IndividualName']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["NAME"]) -> 'IndividualName': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["NAME"]) -> 'IndividualName': ...
