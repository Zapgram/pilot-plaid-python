...
class SandboxTransferTestClockGetRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["test_clock_id", "client_id", "secret", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["test_clock_id", "client_id", "secret", ], str]):
