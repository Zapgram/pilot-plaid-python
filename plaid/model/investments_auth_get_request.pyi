...
class InvestmentsAuthGetRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def options() -> typing.Type['InvestmentsAuthGetRequestOptions']:
                return InvestmentsAuthGetRequestOptions
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["options"]) -> 'InvestmentsAuthGetRequestOptions': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["options"]) -> typing.Union['InvestmentsAuthGetRequestOptions', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        options: typing.Union['InvestmentsAuthGetRequestOptions', schemas.Unset] = schemas.unset,
