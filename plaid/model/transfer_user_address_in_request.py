...
class TransferUserAddressInRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["street", "city", "region", "postal_code", "country", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["street", "city", "region", "postal_code", "country", ], str]):
