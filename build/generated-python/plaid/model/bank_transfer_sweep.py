...
class BankTransferSweep(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["amount"], typing_extensions.Literal["iso_currency_code"], typing_extensions.Literal["created_at"], typing_extensions.Literal["id"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["amount"], typing_extensions.Literal["iso_currency_code"], typing_extensions.Literal["created_at"], typing_extensions.Literal["id"], str, ]):
