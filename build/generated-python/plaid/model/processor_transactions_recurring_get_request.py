...
class ProcessorTransactionsRecurringGetRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["processor_token", "account_ids", "client_id", "secret", "options", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["processor_token", "account_ids", "client_id", "secret", "options", ], str]):
