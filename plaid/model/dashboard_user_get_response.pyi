...
class DashboardUserGetResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["email_address"], typing_extensions.Literal["created_at"], typing_extensions.Literal["id"], typing_extensions.Literal["request_id"], typing_extensions.Literal["status"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["email_address"], typing_extensions.Literal["created_at"], typing_extensions.Literal["id"], typing_extensions.Literal["request_id"], typing_extensions.Literal["status"], str, ]):
