...
class CreditFreddieMacAssetTransactionDetailVOE25(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class AssetTransactionPaidToName(
                schemas.StrBase,
                schemas.NoneBase,
                schemas.Schema,
                schemas.NoneStrMixin
            ...
            __annotations__ = {
                ...
                "AssetTransactionPaidToName": AssetTransactionPaidToName,
    ...
    AssetTransactionPaidToName: MetaOapg.properties.AssetTransactionPaidToName
    AssetTransactionType: 'AssetTransactionType'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["AssetTransactionPaidToName"]) -> MetaOapg.properties.AssetTransactionPaidToName: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["AssetTransactionCategoryType"], typing_extensions.Literal["AssetTransactionPaidByName"], typing_extensions.Literal["AssetTransactionTypeAdditionalDescription"], typing_extensions.Literal["AssetTransactionDate"], typing_extensions.Literal["AssetTransactionPostDate"], typing_extensions.Literal["AssetTransactionPaidToName"], typing_extensions.Literal["AssetTransactionType"], typing_extensions.Literal["AssetTransactionUniqueIdentifier"], typing_extensions.Literal["FinancialInstitutionTransactionIdentifier"], str, ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AssetTransactionPaidToName"]) -> MetaOapg.properties.AssetTransactionPaidToName: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        AssetTransactionPaidToName: typing.Union[MetaOapg.properties.AssetTransactionPaidToName, None, str, ],
        AssetTransactionType: 'AssetTransactionType',
