# plaid.model.recurring_new_transfer_webhook.RecurringNewTransferWebhook
...
------------ | ------------- | ------------- | -------------
dict, frozendict.frozendict,  | frozendict.frozendict,  | Fired when a new transfer of a recurring transfer is originated. | 
...
**webhook_code** | str,  | str,  | &#x60;RECURRING_NEW_TRANSFER&#x60; | 
